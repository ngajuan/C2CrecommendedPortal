import svgPaths from "./svg-z92yb1h92f";
    ...
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full" data-name="Header">
      <div className="h-[21.5px] relative shrink-0 w-[20.235px]" data-name="Union">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.2352 21.5003">
          <g id="Union">
            <path d={svgPaths.p1d879480} fill="url(#paint0_linear_4032_8204)" />
            <path clipRule="evenodd" d={svgPaths.p1b954a00} fill="url(#paint1_linear_4032_8204)" fillRule="evenodd" />
            <path d={svgPaths.p22e3eb80} fill="url(#paint2_linear_4032_8204)" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4032_8204" x1="20.2352" x2="0" y1="10.7501" y2="10.7501">
              <stop stopColor="#2E76B5" />
              <stop offset="0.0001" stopColor="#2E76B5" />
              <stop offset="1" stopColor="#61D690" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_4032_8204" x1="20.2352" x2="0" y1="10.7501" y2="10.7501">
              <stop stopColor="#2E76B5" />
              <stop offset="0.0001" stopColor="#2E76B5" />
              <stop offset="1" stopColor="#61D690" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_4032_8204" x1="20.2352" x2="0" y1="10.7501" y2="10.7501">
              <stop stopColor="#2E76B5" />
              <stop offset="0.0001" stopColor="#2E76B5" />
              <stop offset="1" stopColor="#61D690" />
            </linearGradient>
        ...
        <div className="relative shrink-0 size-[24px]" data-name="Iconly">
          <div className="absolute inset-[8.33%_14.37%_8.9%_14.58%]" data-name="Paper Plus">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.0518 19.8643">
              <path d={svgPaths.p312cd700} fill="var(--fill-0, white)" id="Paper Plus" />
            </svg>
          </div>
        </div>
      </div>
...
function BodyTable() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-[1152px]" data-name="Body Table">
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[143px]" data-name="column">
              ...
              <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Status">
                <div className="relative shrink-0 size-[20px]" data-name="Iconly">
                  <div className="absolute inset-[8.33%]" data-name="Play">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.667 16.667">
                      <path d={svgPaths.p3769d970} fill="var(--fill-0, #156FBE)" id="Play" />
                    </svg>
                  </div>
                </div>
      ...
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[89px]" data-name="column">
      ...
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[117px]" data-name="column">
        <div className="bg-[#f3f3f3] h-[64px] relative shrink-0 w-full" data-name="blocks">
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
      ...
      <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[112px]" data-name="column">
        <div className="bg-[#f3f3f3] h-[64px] relative shrink-0 w-full" data-name="blocks">
          <div className="flex flex-row items-center size-full">
            <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
