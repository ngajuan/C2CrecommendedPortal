import svgPaths from "./svg-ue5w54rois";
  ...
  return (
    <div className="absolute inset-[16.67%_31.25%]" data-name="Arrow - Left 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 10.6667">
        <g id="Arrow - Left 2">
          <path d={svgPaths.p3f3d4080} fill="var(--fill-0, #555555)" id="Arrow - Left 2_2" />
        </g>
      </svg>
    </div>
  );
...
function ArrowRight() {
  return (
    <div className="absolute inset-[16.67%_31.25%]" data-name="Arrow - Right 2">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 10.6667">
        <g id="Arrow - Right 2">
          <path d={svgPaths.p1930a500} fill="var(--fill-0, #555555)" id="Arrow - Right 2_2" />
        </g>
      </svg>
    </div>
  );
