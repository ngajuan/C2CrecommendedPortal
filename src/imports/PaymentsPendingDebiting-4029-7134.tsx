import svgPaths from "./svg-j70ebivjsm";
...
function ActivityTimeline() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[24px] top-[120px] w-[415px]" data-name="Activity timeline">
      <Status />
      <ActivityLine />
      <Event />
    </div>
