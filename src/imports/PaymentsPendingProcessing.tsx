import svgPaths from "./svg-vmx9xlp317";
...
function DetailsBox() {
  return (
    <div className="absolute bg-[#f7f7f7] content-stretch flex gap-[24px] items-start leading-[1.5] left-[471px] not-italic p-[20px] rounded-[6px] text-[#555] text-[16px] top-[556px] w-[657px]" data-name="Details Box">
      <Column />
      <Column1 />
    </div>
  );
...
function Container() {
  return (
    <div className="absolute bg-white h-[804px] left-[264px] overflow-clip rounded-[4px] shadow-[0px_3px_10.25px_0px_rgba(16,39,84,0.1)] top-[238px] w-[1152px]" data-name="Container">
      ...
      <p className="absolute font-['Oxygen:Bold',sans-serif] leading-[0] left-[24px] not-italic text-[#555] text-[0px] text-[16px] top-[104px] w-[226px]">
        <span className="font-['Oxygen:Regular',sans-serif] leading-[1.5]">Estimated arrival is</span>
        <span className="leading-[1.5]">{` `}</span>
        <span className="leading-[1.5] text-[#102754]">January 16</span>
      </p>
      <ActivityTimeline />
      <div className="-translate-y-1/2 absolute flex flex-col font-['Oxygen:Bold',sans-serif] justify-center leading-[0] left-[471px] not-italic text-[#555] text-[24px] top-[514px] w-[165px]">
...
export default function PaymentsPendingProcessing() {
  return (
    <div className="bg-white relative size-full" data-name="Payments / Pending - Processing">
      <SideNavigationBar />
