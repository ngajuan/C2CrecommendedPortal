import svgPaths from "./svg-wssfqyiyh6";

export default function NavigationBar() {
  return (
    <div className="bg-white relative shadow-[0px_1px_3px_0px_rgba(16,39,84,0.1)] size-full" data-name="navigation bar">
      ...
      <div className="-translate-y-1/2 absolute flex h-[65px] items-center justify-center left-[240px] top-[calc(50%-0.5px)] w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
      ...
      <div className="absolute content-stretch flex gap-[16px] items-center right-[24px] top-0" data-name="actions">
        ...
        <div className="flex h-[64px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          <div className="-rotate-90 flex-none">
